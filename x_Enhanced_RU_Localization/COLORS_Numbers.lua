...
--[+ ++ЦИФРЫ++ +]--
	...
	--[+ Таланты +]--
	local Scriers_gaze_rgb = iu_actit("Взор провидца", var_col)
	local Stun_gren_rgb = iu_actit("Оглушающую гранату", var_col)
	local Fury_rgb = iu_actit("Ярость", var_col)
	local Frag_gren_rgb = iu_actit("Фраг-гранату", var_col)
	local Fragmentation_gren_rgb = iu_actit("Фраг-гранату", var_col)
		--[+ Плюс +]--
